...
OCTA500_TRAIN_SIZE = 160 # sugest from literature to have 160, 20, 20 train, test, validation split
...
optimizer = optim.Adam(basic_unet.parameters(), lr=1e-4, weight_decay=1e-5)
